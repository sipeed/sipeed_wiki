...
* [外壳和支架](https://dl.sipeed.com/shareURL/MaixCAM/MaixCAM2/Hardware/assemble_maixcam2)：在[makerworld.com](https://makerworld.com/)（推荐） 或[makerworld.com.cn](https://makerworld.com.cn) 搜索 `MaixCAM`/`MaixCAM2`可以找到一些开源的外壳、支架等 3D 模型文件
* 引脚映射图：
