...
**Tang Mega 138K** 使用 22nm 制程 **GW5AST-LV138PG484AC1/I0** FPGA 芯片，具有 138240 个查找表单元和近 300 个 DSP 单元。含有四个速度范围在 270Mbps ~ 8.0Gbps 高速收发器，适合用于 PCIe 等高速口传递数据。此外，芯片含有硬核 PCIe，在使用 PCIe 的时候消耗更好的资源，并且得到更佳的性能。适用于高速通信、协议转换、高性能计算等场合。
