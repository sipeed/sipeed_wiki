...
2. 左侧选择 Port 和对应波特率（任意选择高波特率），选择 MaixSenseLite 后点击 open 再勾选下方 USB 即可接收大量数据。
...
![ms_carton](./assets/ms_carton.jpg)
...
相关支持：[代码获取。](https://dl.sipeed.com/shareURL/others/metasense_example)
