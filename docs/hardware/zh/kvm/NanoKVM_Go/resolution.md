...
例如，如果 NanoKVM Go 当前使用的是 `1920x1080 60Hz` EDID，被控设备通常不会输出超过该 EDID 声明范围的真实分辨率。如果切换到 `2560x1440 60Hz`、`3440x1440 60Hz` 或 `3840x2160 30Hz` EDID，被控设备才可能显示对应的更高分辨率选项。
...
| 分辨率 | 宽高比 | 1920×1080@60Hz EDID | 2560×1440@60Hz EDID | 3440×1440@60Hz EDID | 3840×2160@30Hz EDID |
| --- | --- | --- | --- | --- | --- |
