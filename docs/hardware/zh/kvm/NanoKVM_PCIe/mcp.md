...
![NanoKVM PCIe 设置页面](./../../../assets/NanoKVM/mcp/nanokvm-settings-page.webp)

5. 找到 MCP 功能选项。

![NanoKVM PCIe MCP 功能入口（中文）](./../../../assets/NanoKVM/mcp/nanokvm-mcp-entry-zh.webp)
...
![NanoKVM PCIe MCP 已开启（中文）](./../../../assets/NanoKVM/mcp/nanokvm-mcp-enabled-zh.webp)
...
![OpenCode 已连接 NanoKVM PCIe MCP](./../../../assets/NanoKVM/mcp/opencode-mcp-connected.webp)

连接成功后，可以给 OpenCode 发送指令，让 OpenCode 通过 NanoKVM PCIe MCP 查看并操作被控设备。

![OpenCode 通过 NanoKVM PCIe MCP 读取当前屏幕内容](./../../../assets/NanoKVM/mcp/opencode-read-screen-result-zh.webp)
