...
- [Sipeed SDK](https://gitee.com/sipeed/M1s_BL808_SDK) (gitee)
- [Sipeed Examples](https://gitee.com/sipeed/M1s_BL808_example)（gitee）
...
Sipeed M1s Dock 开发板可以在多种场景实现客户不同方面的需要，技术支持和商业合作请联系邮箱 [support@sipeed.com](support@sipeed.com)
