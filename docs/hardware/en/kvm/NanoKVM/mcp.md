...
![NanoKVM Cube settings page](./../../../assets/NanoKVM/mcp/nanokvm-settings-page.webp)

5. Find the MCP option.

![NanoKVM Cube MCP entry](./../../../assets/NanoKVM/mcp/nanokvm-mcp-entry-en.webp)
...
![NanoKVM Cube MCP enabled](./../../../assets/NanoKVM/mcp/nanokvm-mcp-enabled-en.webp)
...
![OpenCode connected to NanoKVM Cube MCP](./../../../assets/NanoKVM/mcp/opencode-mcp-connected.webp)
...
![OpenCode reading the current screen through NanoKVM Cube MCP](./../../../assets/NanoKVM/mcp/opencode-read-screen-result-en.webp)
