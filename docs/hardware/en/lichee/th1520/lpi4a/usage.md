...
![usage_serial_login_test](./../../../../zh/lichee/th1520/lpi4a/assets/usage/usage_serial_login_test.png)
...
![usage_login_remove_gpu_file](./../../../../zh/lichee/th1520/lpi4a/assets/usage/usage_login_remove_gpu_file.png)
...
![usage_debian_lsusb_list_device](./../../../../zh/lichee/th1520/lpi4a/assets/usage/usage_debian_lsusb_list_device.png)
...
<table>
    ...
    <tr>
        <td colspan=2> 运行命令后桌面新增了一个名为 udisk 的文件夹，使用鼠标双击打开 udisk 文件夹后可以看到文件夹里面的内容与 U 盘里面的实际内容一致 <img src="./../../../../zh/lichee/th1520/lpi4a/assets/usage/usage_debian_udisk_open_folder.png" alt="usage_debian_udisk_open_folder"></td>
    </tr>
</table>
...
![usage_debian_list_audio_file](./../../../../zh/lichee/th1520/lpi4a/assets/usage/usage_debian_list_audio_file.png)
